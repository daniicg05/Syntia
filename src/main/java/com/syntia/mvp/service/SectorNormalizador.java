...
public final class SectorNormalizador {
    ...
    /**
     * Normaliza un sector de texto libre a un término de búsqueda optimizado para la API BDNS.
     * <p>
     * Si el sector coincide con una variante conocida, devuelve el término BDNS mapeado.
     * Si no se reconoce, devuelve el texto original limpio (lowercase, max 60 chars)
     * prefijado con "subvencion" para mejorar la relevancia en BDNS.
     *
     * @param sectorLibre texto libre del campo sector (puede ser null o blank)
     * @return término de búsqueda BDNS, o null si la entrada es null/blank
     */
    public static String normalizarABusqueda(String sectorLibre) {
        ...
        // Fallback: usar el texto original como término de búsqueda
    ...
    /**
     * Comprueba si un sector de texto libre tiene un mapeo conocido.
     *
     * @param sectorLibre texto libre del campo sector
     * @return true si el sector tiene un término BDNS conocido
     */
    ...
    /** Registra una variante en el mapa. */
